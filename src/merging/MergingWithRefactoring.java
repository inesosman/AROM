...
//		alignmentsFiles.add("Data/iasted-sigkdd.rdf");
	...
	public static int getMergedNamesForEquivalentEntitiesUsingRepairedAndFilteredAlignments(String alignmentFile, double threshold, HashMap<String, String> hash_un, HashMap<String, HashSet<String>> hash_deux, int k, HashSet<String> redundantEntities) throws AlignmentException{
